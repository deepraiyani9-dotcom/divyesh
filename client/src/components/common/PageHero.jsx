...
const PageHero = ({ title, subtitle, breadcrumb = [] }) => {
  return (
    <section className="relative bg-brand overflow-hidden pt-32 pb-16 md:pt-40 md:pb-20">
      <div
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          {subtitle && <p className="mt-4 max-w-2xl text-slate-100 text-base md:text-lg">{subtitle}</p>}
        </motion.div>
      </div>
    </section>
  );
