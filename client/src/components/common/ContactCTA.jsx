  ...
  return (
    <section className="section-padding bg-brand relative overflow-hidden">
      <div className="absolute inset-0 opacity-20" style={{
        backgroundImage: 'radial-gradient(circle at 15% 50%, #0D7377 0%, transparent 50%), radial-gradient(circle at 85% 30%, #E07A3D 0%, transparent 45%)',
      }} />
      <div className="container-custom relative z-10">
        ...
        >
          <div>
            ...
            <p className="text-slate-100 max-w-xl">
